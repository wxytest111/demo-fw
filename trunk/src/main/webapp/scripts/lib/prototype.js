...
Element.Methods = {
  ...
  recursivelyFind: function(element, property, expression, index) {
  ...
  up: function(element, expression, index) {
    ...
    return Element.recursivelyFind(element, 'parentNode', expression, index);
  },
  ...
  previous: function(element, expression, index) {
    element = $(element);
    return Element.recursivelyFind(element, 'previousSibling', expression, index);
  },

  next: function(element, expression, index) {
    element = $(element);
    return Element.recursivelyFind(element, 'nextSibling', expression, index);
  },
...
if (Prototype.Browser.Opera) {
  ...
  $w('colSpan rowSpan vAlign dateTime accessKey tabIndex ' +
      'encType maxLength readOnly longDesc itemBorder').each(function(attr) {
...
Element.addMethods = function(methods) {
  ...
  function findDOMClass(tagName) {
    ...
    var trans = {
      ...
      "TableRow", "TH": "TableCell", "TD": "TableCell", "ITEMSET":
      "ItemSet", "IITEM": "IItem"
    };
